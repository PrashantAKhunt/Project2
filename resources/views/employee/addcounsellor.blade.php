<x-app-layout>
    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('counsellor.admin.register') }}" enctype="multipart/form-data">
        @elseif(Auth::user()->hasRole('manager'))
        <form method="POST" action="{{ route('counsellor.manager.register') }}" enctype="multipart/form-data">
        @elseif(Auth::user()->hasRole('branch'))
        <form method="POST" action="{{ route('counsellor.branch.register') }}" enctype="multipart/form-data">
        @endif
            @csrf
