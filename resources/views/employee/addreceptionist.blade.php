<x-app-layout>
    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('receptionist.admin.register') }}" enctype="multipart/form-data">
        @elseif(Auth::user()->hasRole('manager'))
        <form method="POST" action="{{ route('receptionist.manager.register') }}" enctype="multipart/form-data">
        @elseif(Auth::user()->hasRole('branch'))
        <form method="POST" action="{{ route('receptionist.branch.register') }}" enctype="multipart/form-data">
        @endif
            @csrf
