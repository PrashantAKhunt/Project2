<x-app-layout>
    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('mobiliser.admin.register') }}" enctype="multipart/form-data">
        @elseif(Auth::user()->hasRole('manager'))
        <form method="POST" action="{{ route('mobiliser.manager.register') }}" enctype="multipart/form-data">
        @elseif(Auth::user()->hasRole('branch'))
        <form method="POST" action="{{ route('mobiliser.branch.register') }}" enctype="multipart/form-data">
        @endif
